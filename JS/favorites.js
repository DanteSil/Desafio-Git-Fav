...
export class FavoritesView extends Favorites {
  ...
  onAdd() {
    const addButton = this.root.querySelector('.addFav')
    addButton.onclick = () => {
  ...
  createRow() {
    ...
    const content = `
    <td class="user">
      <img src="https://github.com/DanteSil.png" alt="Ramon">
      <a href="https://github.com/DanteSil">
        <p>Ramon Lima</p>
        <span>/DanteSil</span>
      </a>
    </td>
    <td class="repositories">123</td>
    <td class="followes">1234</td>
